  ...
  return (
    <div class="reservation">
      <div class="reservation_inner">
        <h3 class="reservation_inner_text_top">Many Rooms to Choose</h3>
        <p class="reservation_inner_text_main">
        ...
        <a href="#" class="btn_reservation_inner">
          Explore more
        </a>
      </div>
      <div class="reservation_main">
        <div class="reservation_main_first">
          <img src={room_first} alt="#" class="room_first" />
          <h2>Single Room</h2>
          <p>
        ...
        <div class="reservation_main_two">
          <img src={room_two} alt="#" class="room_two" />
          <h2>Double Room</h2>
          <p>
        ...
        <div class="reservation_main_three">
          <img src={room_three} alt="" class="room_three" />
          <h2>Cootage</h2>
          <p>
